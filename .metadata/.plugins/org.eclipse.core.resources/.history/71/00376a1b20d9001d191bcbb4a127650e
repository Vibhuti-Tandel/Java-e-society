...
<head>
  ...
  <!-- google fonts -->
  <link href="admin/assets/css/style-starter.css" rel="stylesheet">
                ...
                <div class="card-body">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control login_text_field_bg input-style" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required="" autofocus="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="input__label">Password</label>
                            <input type="password" class="form-control login_text_field_bg input-style" id="exampleInputPassword1" placeholder="" required="">
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-wrap justify-content-between">
                            ...
                            <p class="signup mt-4">Don't have an account? <a href="#" class="signuplink">Sign
                                    up</a></p>
                        </div>
                    </form>
                    <!-- //form -->
                    <p class="backtohome mt-4"><a href="index.jsp" class="back"><i class="fa fa-chevron-left" aria-hidden="true"></i>Back to Home </a></p>
                </div>
            </div>
        </section>
